...
Once the cleanup lands, the contract should live somewhere consumers can find it. Recommend appending to `docs/documentation/` (the AC CSS knowledge base) — specifically a new doc at `06-app-layers/05-site-regions.md`:
...
8. **Pass 3 §5** — document the regional contract in `docs/documentation/`.
