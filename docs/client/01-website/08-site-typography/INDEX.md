...
related:
  ...
  - "[[06-app-layers/05-site-typography|ac-docs reference]]"
---
...
5. Document the role in this doc and in the ac-docs reference at `docs/documentation/06-app-layers/05-site-typography.md`.
...
- `docs/documentation/06-app-layers/05-site-typography.md` — peer reference doc inside the AC CSS knowledge base (same content, AC-docs-framework-conformant).
