...
This folder follows [the kol-docs framework](../../../.kol/docs-framework/INDEX.md) — frontmatter schema, numbered prefixes, INDEX-when-it-adds-signal, explicit-with-display wikilinks. Migrated from the original flat layout on 2026-05-18.
