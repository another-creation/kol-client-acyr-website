...
Cascade order is load-bearing — see [[01-cascade/INDEX|cascade]].
...
|---|---|
| [[00-cheatsheets/01-typography\|typography cheatsheet]] | Every text class in the repo, in tables. Class · family · size · weight · line-height · tracking · transform · use. |
| [[00-cheatsheets/02-color\|color cheatsheet]] | Every color token and color class in the repo, in tables. Brand ramps with hex, surfaces (light + dark), accent, UI state, foreground opacity ramps (3 tiers × 14 stops × 3 properties), descriptor classes. |

## Sections

| Section | Contents |
|---|---|
| [[01-cascade/INDEX\|cascade]] | The 13-import cascade in `packages/ds/index.css`. What loads when, what overrides what, what breaks if reordered. |
...
| [[05-framework/INDEX\|framework]] | Page scaffold + layout: `framework.css`. |
...
| [[07-finding-the-right-class/INDEX\|finding the right class]] | Decision tree — "I need to style X, where do I look?" |

## How to use this folder

- **Before writing a new class:** open [[07-finding-the-right-class/INDEX|finding the right class]] and grep for the concept (kicker, heading, button, surface, etc.). If it exists, use it.
...
All docs here follow the kol-docs framework spec at `.kol/docs-framework/`. Frontmatter schema, archetypes, tag taxonomy, wikilink form — see [_framework](../../.kol/docs-framework/INDEX.md).
