...
Don't reorder this cascade without reading this doc end-to-end and writing the symptom into the table above. ARCHITECTURE §4 also locks this — see `docs/llm-context/ARCHITECTURE.md`.
