...
export default function Testimonial({ quote, cite }) {
  const containerRef = useRef(null)

  // Quote, cite fade up in sequence — quote reveals as a single block.
  ...
  return (
    <section className="bg-surface-primary text-on-primary px-5 md:px-8 lg:px-14 py-16 md:py-24">
      <div ref={containerRef} className="max-w-[1400px] h-[600px] mx-auto flex flex-col justify-center text-center">
